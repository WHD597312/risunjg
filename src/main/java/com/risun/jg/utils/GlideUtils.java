...
public class GlideUtils {
    ...
    public static void LoadImage(Context mContext, String path,
                                 ImageView imageview) {
        Glide.with(mContext).load(path).centerCrop().placeholder(R.drawable.img01)
    ...
    public static void LoadCircleImage(Context mContext, int path,
                                       ImageView imageview) {
        Glide.with(mContext).load(R.drawable.img01).
                asBitmap().centerCrop()
                .placeholder(R.drawable.img01)
                .transform(new com.risun.jg.utils.GlideCircleTransform(mContext))
                .into(imageview);
